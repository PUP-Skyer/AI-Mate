...
3D 沉浸式数据看板，实时呈现 AI 行业资讯总量、行业新闻分类、AI 大事件时间轴、各行业 AI 渗透率及主流 AI 工具库，帮助创业者一站式洞察市场风向。

![探路者AI 市场分析看板](ai-mate/docs/images/scout-market-analysis.png)

### 技能库管理

平台内置 40+ 创业技能（市场调研、BP 精炼、代码审查、营销文案、PPT 生成等），支持按分类筛选、斜杠命令触发、自动工作流编排，即开即用。

![技能库管理](ai-mate/docs/images/skill-library.png)

### 行业报告中心

聚合 20+ 权威机构、20 篇精选行业报告，覆盖人工智能、新能源、智能制造、生物医药、金融科技等 7 大赛道，支持搜索、收藏与热度排序。

![行业报告中心](ai-mate/docs/images/industry-report.png)

### AI 智能对话

四大 AI 数字员工（探路者/军师/工匠/管家）各司其职，提供创业方向分析、投资人对接、供应商推荐、商业模式拆解等专业服务，支持快捷入口一键发起对话。

![AI 智能对话](ai-mate/docs/images/ai-chat.png)
